...
describe('Web Read Options:', () => {
  ...
  before((done) => {
    ...
    // registrations
    Mebo.registerAction(UploadPreserveName, 'uploadAction');
    Mebo.registerAction(UploadVectorPreserveFileName, 'vectorUploadAction');
    Mebo.registerAction(UploadTestFolder, 'uploadTestFolder');

    // webfying actions
    Mebo.webfyAction('uploadTestFolder', 'put', {restRoute: '/uploadTestFolder'});
    Mebo.webfyAction('uploadAction', 'post', {restRoute: '/E'});
    Mebo.webfyAction('vectorUploadAction', 'post', {restRoute: '/E/VectorUploadAction'});
