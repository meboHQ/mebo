...
describe('Web Restful Generic:', () => {
  ...
  before((done) => {
    ...
    Mebo.registerAction(ForceToFail);
    Mebo.registerAction(CheckRemoteAddress);
    Mebo.registerAction(UndefinedResult);
    Mebo.registerAction(JSONRepresentation);

    // webfying actions
    Mebo.webfyAction('sum', 'get', {restRoute: '/A'});
    Mebo.webfyAction('sum', 'patch', {restRoute: '/A/:a/test'});
    Mebo.webfyAction(ForceToFail, 'get', {restRoute: '/forceToFail'});
    Mebo.webfyAction(CheckRemoteAddress, 'get', {restRoute: '/checkRemoteAddress'});
    Mebo.webfyAction(UndefinedResult, 'get', {restRoute: '/undefinedResult'});
    Mebo.webfyAction(JSONRepresentation, 'get', {restRoute: '/jsonRepresentation'});
  ...
  it('Should assign an input value as autofill', (done) => {
    ...
    Mebo.registerAction(AvailableActionE);
    ...
    Mebo.registerAction(TestAutofillAction);
    Mebo.webfyAction(TestAutofillAction, 'post', {auth: false, restRoute: '/TestAutofillAction'});
    Mebo.restful(app);
  ...
  it('Should test the defaults of the web handler', (done) => {
    class WebCustom extends Mebo.Ext.Handlers.Web{
    }

    Mebo.registerAction(testutils.Actions.Shared.Sum, 'sum.testDefault');
    Mebo.registerHandler(WebCustom, 'web', 'sum.testDefault');
    Mebo.webfyAction('sum.testDefault', 'get', {auth: false, restRoute: '/testDefault'});
    Mebo.restful(app);
  ...
  it('Should perform an action using a registered with a custom route', (done) => {
    ...
    Mebo.registerAction(testutils.Actions.Shared.Sum, 'sum');
    Mebo.webfyAction('sum', 'get', {auth: false, restRoute: '/:api/a/b/c/Sum'});
    Mebo.restful(app);
  ...
  it('Should use a prefix in the restful support', (done) => {
    ...
    Mebo.webfyAction('sum.testPrefix', 'get', {restRoute: '/testPrefix'});
