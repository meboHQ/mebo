...
describe('Web Write Options:', () => {
  ...
  class HeaderOnly extends testutils.Actions.Shared.Sum{
    constructor(){
      super();
      this.setMeta('$webHeadersOnly', true);
    }
  }
  ...
  class CustomHeader extends Mebo.Action{
    ...
    _perform(data){
      this.setMeta('$webHeaders.date', data.customDate);
  ...
  class ForceResultLabel extends Mebo.Action{
    ...
    _perform(data){
      ...
      if (data.resultLabel){
        this.setMeta('$webResultLabel', data.resultLabel);
      }
  ...
  before((done) => {
    ...
    // registrations
    Mebo.Action.register(HeaderOnly, 'headerOnly');
    Mebo.Action.register(ForceResultLabel, 'forceResultLabel');
    Mebo.Action.register(SuccessStatus, 'successStatus');
    Mebo.Action.register(CustomHeader, 'customHeader');
    Mebo.Action.register(CustomOutput, 'customOutput');
    Mebo.Action.register(CustomRoot, 'customRoot');
    Mebo.Action.register(testutils.Actions.Shared.Sum, 'sum');

    // webfying actions
    Mebo.Handler.grantAction('web', 'sum', {restRoute: '/sum'});
    Mebo.Handler.grantAction('web', 'headerOnly', {restRoute: '/headersOnly'});
    Mebo.Handler.grantAction('web', 'successStatus', {restRoute: '/successStatus'});
    Mebo.Handler.grantAction('web', 'customHeader', {restRoute: '/customHeader'});
    Mebo.Handler.grantAction('web', 'forceResultLabel', {restRoute: '/forceResultLabel'});
    Mebo.Handler.grantAction('web', 'customOutput', {restRoute: '/output'});
    Mebo.Handler.grantAction('web', 'customRoot', {restRoute: '/root'});
